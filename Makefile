...
pkgdatadir = $(datadir)/cryptoquery
pkgincludedir = $(includedir)/cryptoquery
pkglibdir = $(libdir)/cryptoquery
pkglibexecdir = $(libexecdir)/cryptoquery
...
LIBOBJS = 
LIBS = -lreadline -lsqlite3 -lpbc -lgmp -lm 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/stefano/Dropbox/GitHUB/cryptoquery/missing makeinfo
MKDIR_P = ./install-sh -c -d
OBJEXT = o
PACKAGE = cryptoquery
PACKAGE_BUGREPORT = stefano.braghin@gmail.com
PACKAGE_NAME = cryptoquery
PACKAGE_STRING = cryptoquery 0.0.1
PACKAGE_TARNAME = cryptoquery
PACKAGE_URL = 
